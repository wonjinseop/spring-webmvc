...
<body>
    ...
    <script>
        ...
        $sendBtn.onclick = e => {
            ...
            /*
            fetch(URL, {요청에대한 여러 정보가 담긴 객체})
            여러 정보로는 전송 방식(method), header에 추가할 내용, body에는 전송할 JSON 데이터를 첨부.
            */
            ...
            // 받아서 처리할 수 있는 콜백 방식의 함수를 매개값으로 전달받습니다.
