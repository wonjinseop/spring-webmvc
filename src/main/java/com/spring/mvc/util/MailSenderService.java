...
import com.spring.mvc.config.EmailConfig;
...
public class MailSenderService {
    ...
    public String joinEmail(String email) { // 컨트롤러로부터 이메일을 전달받음.
        ...
        String setFrom = "wonjinseop7@naver.com"; // EmailConfig에 설정한 발신용 이메일과 똑같이!
        ...
        String content = "홈페이지 가입을 신청해 주셔서 감사합니다." +
                ...
                "해당 인증번호를 인증번호 확인란에 기입해 주세요."; // 이메일에 삽입할 내용 (더 꾸며보세요)
