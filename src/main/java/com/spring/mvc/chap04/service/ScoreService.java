...
import com.spring.mvc.chap04.dto.ScoreReponseDTO;
...
public class ScoreService {
     ...
     */
    public List<ScoreReponseDTO> findAll(String sort) {
        List<ScoreReponseDTO> dtoList = new ArrayList<>();

        List<Score> scoreList = repository.findAll(sort);
        for (Score score : scoreList) {
            ScoreReponseDTO dto = new ScoreReponseDTO(score);
            dtoList.add(dto);
        }
