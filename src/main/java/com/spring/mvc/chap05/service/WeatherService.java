...
public class WeatherService {
    ...
    public void getShortTermForecast(String area1, String area2) {
        ...
        try {
            ...
            urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=r6EAnf9Un1vpRFhLYHY8f2GZQzMB0O%2FBWWeYNlnS0TZtyO7m6k8stWkCERJ7twxUCbmL3dF2Mayp%2Bwa2TP6Vmw%3D%3D"); /*Service Key*/
            ...
            urlBuilder.append("&" + URLEncoder.encode("nx","UTF-8") + "=" + URLEncoder.encode(map.get("nx").toString(), "UTF-8")); /*예보지점의 X 좌표값*/
            urlBuilder.append("&" + URLEncoder.encode("ny","UTF-8") + "=" + URLEncoder.encode(map.get("ny").toString(), "UTF-8")); /*예보지점의 Y 좌표값*/
...
//            System.out.println(sb.toString());
            ...
            // "response"라는 키에 해당하는 JSON 데이터를 가져옵니다.
